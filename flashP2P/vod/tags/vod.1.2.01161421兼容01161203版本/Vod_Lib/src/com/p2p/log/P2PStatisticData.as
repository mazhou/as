package com.p2p.log
{
	...
	public class P2PStatisticData extends EventDispatcher
	{
		...
		private var _sumSize:Number = 0;     //总下载文件大小(字节)
		...
		public function getStatisticData():Object
		{
			...
			obj.alltime  = obj.p2ptime + _httpTime;    //心跳周期内总下载耗费时间(毫秒)	    Number
			...
			//20130111 add 
			_sumSize     += obj.p2psize+obj.httpsize;
			_sumP2PTime  += obj.p2ptime;
			_sumHttpTime += _httpTime;
			obj.sumSize   = _sumSize;                   //从播放开始总的下载文件大小（字节）   Number
			obj.sumTime   = _sumHttpTime+_sumP2PTime;   //从播放开始总下载耗时（毫秒）         Number
