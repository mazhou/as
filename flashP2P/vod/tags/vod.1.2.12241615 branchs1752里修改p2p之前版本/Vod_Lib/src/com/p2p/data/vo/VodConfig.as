package com.p2p.data.vo
{
	...
	{
		/**内核版本号*/
		public static var VERSION:String = "vod.1.2.09171142";
		/**协议版本号*/
		public static const P2P_AGREEMENT_VERSION:String = "1_2_06141752";
		/**点播设置，内存最大字节*/
		 ...
		 * 单位：毫秒
		 * */
		private static var _adRemainingTime:Number = 0;
		...
		public static function getAdRemainingTime():Number
		{
			...
			return _adRemainingTime-((new Date).time-_locationADTime);
		}
	}
}