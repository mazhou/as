...
//		private var j:int=0;
	...
	//					Debug.traceMsg(this,"2.加载的数据是 :\n"+str);
				...
				Debug.traceMsg(this,"http解析数据错误");
			}
		}
