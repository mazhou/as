package com.p2p.statistics
{
	...
	public class Statistic
	{
		...
		public function isLeader():void
		{
			...
			var object:Object = new Object();
			object.name = "time";
			object.info = String("leader="+LiveVodConfig.IS_REAL_LEAD);
			testCallBack(object);
			/**外部输出面板使用*/
		...
		/**输出面板上报*/
		public function setPlayHead(id:Number):void
		{
			/**内部输出面板上报*/
			var object:Object = new Object();
		...
		/**输出面板上报*/
		public function loadXMLSuccess(utime:Number,minute:Number):void
		{
			/**过程上报使用*/
