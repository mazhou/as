package com.p2p.dataManager
{
	...
	{
		function getNextNearBlock(id:Number,isHaveData:Boolean=false):Block;
		/**获得blockid*/
		function getBlockId(blockId:Number):Number;
		/**获得id所的对应的分钟最小的block id*/
		function getMiniMinBlock(id:Number):Number;
		/**获得id所的对应的分钟最大的block id*/
		function getMaxMinBlock(id:Number):Number;
		/**读取字节*/
...
//		function  headTimestamp():Number;
		...
		function get downloadTaskTime():Timer;
	}
}