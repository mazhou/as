...
//		/**播放器播放用到的时间*/
		...
		/**暂停的时间点*/
//		protected var pauseTime:Number=0;
//		/**直播点时间*/
//		protected var liveTime:Number=0;
		...
		/**ok:正常,null为空,big:大于基准时间*/
		private var _getBlockState:String="ok";
...
//			publishHead(_startTime);
		...
		protected function frameHandler():void
		{
			...
			{
				if (isReadResetBegin() && _addStreamStep == PlayData.FRAME 
				    && LIVE_TIME.GetBaseTime() > (block.id + block.duration/1000))
				{
		...
		/***/
//		private function reducePauseBastTime():Number
//		{
//			if(this._isPause){
//				return pauseTime;//LIVE_TIME.GetBaseTime()-(this.getTime()-this.pauseTime);
//			}else{
//				return LIVE_TIME.GetBaseTime()
//			}
//		}
