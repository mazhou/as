...
//			}else return;
		...
		{
			if(!isPause && _isBufferEmpty && getBufferTime()>LiveVodConfig.Buffer_Count_Time*1000)
			{
				reseek(LIVE_TIME.GetBaseTime()+getBufferTime());
			}
			if(isPause)
			{
				return;
