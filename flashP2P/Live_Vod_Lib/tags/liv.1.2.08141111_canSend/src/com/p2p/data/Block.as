package com.p2p.data
{
	...
	{	
		...
		public function creatPiece(pieceID:int,size:Number):void{
...
//			{
//				P2PDebug.traceMsg(this,">>>"+this.id+"_"+pieceID);
//			}
		}
		public function set size(_size:Number):void
		{
			...
			while(_size-LiveVodConfig.CLIP_INTERVAL>0)
			{
				...
				creatPiece(i,LiveVodConfig.CLIP_INTERVAL);
				i++;
			}
		...
		{			
			...
			{
				doReload(remoteName.substr(0,8),pieceID);
