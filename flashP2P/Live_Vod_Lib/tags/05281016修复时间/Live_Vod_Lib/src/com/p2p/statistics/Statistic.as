package com.p2p.statistics
{
	...
	public class Statistic
	{
		...
		{
			Debug.traceMsg(this,"统计响应play事件");
			_initData=evt.data as InitData;	
			if(outMsg != null)
			{
				outMsg(Config.VERSION,"version");
			}			
			/**设置KernelReport*/
			KernelReport.SET_INFO(Config.VERSION,_initData.groupName,"live")
		...
		public function isLeader():void
		{
			...
			var object:Object = new Object();
			object.name = "time";
			object.info = String("leader="+Config.IS_REAL_LEAD);
			testCallBack(object);
		}
		/**输出面板上报*/
		...
		public function P2PGetData(id:String,begin:Number,end:Number,size:Number,peerID:String):void
		{
			...
			{
				Debug.traceMsg(this,"p2p时间报NaN啦~~~~~~");
			}
			_p2psizeNum += size;					
		...
		public function httpGetData(id:String,begin:Number,end:Number,size:Number):void
		{
			...
			_httpsizeNum += size;
			_downLoadBoo=true;
			Debug.traceMsg(this,"_httpTimeNum = "+_httpTimeNum+"   _httpsizeNum = "+_httpsizeNum)
			/**外部输出面板使用*/
			 if(outMsg != null)
			 {
		...
		public function getStatisticData():Object
		{
			 ...
			 * type  live或vod
			 * */
			var str:String = String(nativeTrafficPath+"csize="+_httpsizeNum+"&dsize="+_p2psizeNum+"&dnode="+obj.dnode+"&lnode="+obj.lnode+"&gip="+_gIP+"&gport="+_gPort+"&rip="+_rIP+"&rport="+_rPort+"&gID="+_initData.groupName+"&ver="+Config.VERSION+"&type=live");			
