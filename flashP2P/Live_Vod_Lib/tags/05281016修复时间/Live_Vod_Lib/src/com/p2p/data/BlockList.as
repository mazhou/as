package com.p2p.data
{
	...
	public class BlockList 
	{
		...
		public function traceBlockList():String{
			Debug.traceMsg(this,"blockList:",_toString());
		...
		{
			_tempDateObj = TimeTranslater.getHourMinObj(clip.timestamp);	
...
//			Debug.traceMsg(this,"添加block"+block.id);
		...
		{
			_tempDateObj = TimeTranslater.getHourMinObj(id);
		...
		public function setLastClipFull(time:Number):void{
			_tempDateObj = TimeTranslater.getHourMinObj(time);
			_tempDateObj.min-=1;
