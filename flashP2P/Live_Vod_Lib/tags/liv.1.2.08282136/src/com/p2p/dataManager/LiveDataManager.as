...
//									return block;
							...
							//
//							if ( /*objEarliestTimeAndLeaderName["earliestTime"] == Number.MAX_VALUE ||*/
//								 objEarliestTimeAndLeaderName["earliestTime"] < LiveVodConfig.START_RUN_TIME/*this.startTime*/) //如果其他节点的运行时间早于本地运行时间
//							{
