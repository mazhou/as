package com.hls_p2p.data.vo
{
	...
	public class LiveVodConfig
	{
		...
		private static var _NEAREST_WANT_ID:Number = 0;
		...
		public static var DAT_BUFFER_TIME:Number	= 30;//7;
		...
		//PLAY***********************************************************************************************
		/**内核版本号*/
		private static const VOD_VERSION:String  = "vod.3.0.11291110";
		private static const LIVE_VERSION:String = "liv.3.0.12051449";
		...
		/**P2P协议版本号 */
		private static const P2P_AGREEMENT_VOD_VERSION:String  = "1.3m3u8_11151520";//"1.3m3u8_11051326";//0909122->加removeHaveData功能
		private static const P2P_AGREEMENT_LIVE_VERSION:String = "1.3m3u8_11251830";//"1.3m3u8_11051326";
	}
}