package com.hls_p2p.data.vo
{
	public class LiveVodConfig
	{
		...
		/**每次请求DESC的时移时间*/
		public static var M3U8_MAXTIME:Number 	= -1;
		//DAT***********************************************************************************************
		...
		//PLAY***********************************************************************************************
		/**内核版本号*/
		private static const VOD_VERSION:String  = "vod.3.0.11261017";
		private static const LIVE_VERSION:String = "liv.3.0.11261017";
		...
		/**P2P协议版本号 */
		private static const P2P_AGREEMENT_VOD_VERSION:String  = "1.3m3u8_11251830";//"1.3m3u8_11151520";//"1.3m3u8_11051326";//0909122->加removeHaveData功能
