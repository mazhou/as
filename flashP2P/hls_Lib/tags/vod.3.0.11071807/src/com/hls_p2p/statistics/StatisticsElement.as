package com.hls_p2p.statistics
{
	...
	internal class StatisticsElement
	{
		...
		public function StatisticsElement()
		{
		...
		public function getStatisticData(evt:TimerEvent=null):Object
		{
			...
			try
			{
				...
				if(rtmfpSuccess)
				{
					...
					obj.lnode  = Math.round((lnodeTotal/lnodeTimes) * 10)/10;
					obj.dnode  = Math.round((dnodeTotal/dnodeTimes) * 10)/10;
				}else
				{
					obj.lnode = -1;
					obj.dnode = -1;
