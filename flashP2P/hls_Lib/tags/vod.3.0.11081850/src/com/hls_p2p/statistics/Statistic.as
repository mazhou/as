package com.hls_p2p.statistics
{
	...
	public class Statistic
	{
		...
		private var _groupList:Object = new Object();
		...
		{			
			...
			for(var i:String in _groupList)
			{
				_groupList[i].clear();	
				delete _groupList[i];
			}			
...
//			outMsg=null;
		...
		public function creatStatisticByGroupID(id:String):void
		{
			if( !_groupList[id] )
			{
				_groupList[id] = new StatisticsElement(id);
				_groupList[id].start();
			}
		}
