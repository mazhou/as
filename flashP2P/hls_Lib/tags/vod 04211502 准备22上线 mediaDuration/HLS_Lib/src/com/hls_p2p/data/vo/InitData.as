package com.hls_p2p.data.vo
{
	...
	public dynamic class InitData
	{
		...
		{
			/**
			 * 当播放器正在播放广告且_adRemainingTime>5*1000毫秒时，执行p2p优先加载的策略；
			 * 当_adRemainingTime<=5*1000毫秒时，执行正常加载策略
			 * */
			if(getAdRemainingTime() <= 5*1000 || this.playlevel == 1)
			{
				return false;
			}
			return true;
		...
		{
			P2PDebug.traceMsg(this,"_pieceFailedCount = "+_pieceFailedCount)
		...
		{
			P2PDebug.traceMsg(this,"LiveVodConfig.BlockID = "+LiveVodConfig.BlockID+", bID = "+bID);
			P2PDebug.traceMsg(this,"LiveVodConfig.PieceID = "+LiveVodConfig.PieceID+", pID = "+pID);
				...
				&& _playingPieceID == LiveVodConfig.PieceID )
			{
				...
				{
					P2PDebug.traceMsg(this,"LiveVodConfig.BlockID = "+LiveVodConfig.BlockID);
					P2PDebug.traceMsg(this,"LiveVodConfig.PieceID = "+LiveVodConfig.PieceID);
					P2PDebug.traceMsg(this,"getAdRemainingTime() + "+getAdRemainingTime())
					_pieceFailedCount++;
				}
			}
			else
			{
				...
				{
					P2PDebug.traceMsg(this,"_pieceFailedCount = 0 LiveVodConfig.BlockID = "+LiveVodConfig.BlockID);
					P2PDebug.traceMsg(this,"_pieceFailedCount = 0 LiveVodConfig.PieceID = "+LiveVodConfig.PieceID);
					_pieceFailedCount = 0;
				}
...
//			value=replaceParam(value,"format","2");
		...
		public function get cdnInfo():Array
		{
			return _flvURL;
		}
