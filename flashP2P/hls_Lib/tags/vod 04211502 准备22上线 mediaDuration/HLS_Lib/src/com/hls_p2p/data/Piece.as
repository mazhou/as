...
//			P2PDebug.traceMsg(this,"reset:"+this.id+" pieceKey:"+this.pieceKey+" ty:"+" bID",blockIDArray);
		...
		{
			P2PDebug.traceMsg(this,"clearStream: id:"+this.id+" pKey:"+this.pieceKey,"bID:"+blockID+" ,blockIDArray:"+blockIDArray,_blockList);
			if( -1 != blockIDArray.indexOf(blockID) )
			{
				blockIDArray.splice(blockIDArray.indexOf(blockID),1);
				if( blockIDArray.length != 0 )
				{
					P2PDebug.traceMsg(this,"clearStream: bID:"+blockID+" ,blockIDArray:"+blockIDArray);
					return;
				}
			}
