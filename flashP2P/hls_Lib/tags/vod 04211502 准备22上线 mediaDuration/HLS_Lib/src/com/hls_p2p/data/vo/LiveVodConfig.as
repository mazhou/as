...
//		}
		...
		/**播放不超过这个缓冲值，超过将不再喂数据*/
		public static var BufferTimeLimit:Number	= 10;
		/**开始运行的时间*/
		...
		public static var TEST_ID_1:String 	 	 = "channel_1ver_00_101.3m3u8_12272000";
...
//			LiveVodConfig.MEMORY_SIZE   		= 300*1024*1024;
		...
		//PLAY***********************************************************************************************
		/**内核版本号*/
		private static const VOD_VERSION:String  = "vod.3.0.03171422";
		private static const LIVE_VERSION:String = "liv.3.0.03071225";
		
		private static const VOD_TEMP_VERSION:String  = "_04221245";//"_01221046";//"_01061440";
		private static const LIVE_TEMP_VERSION:String = "_04010917";//"_02180943";//"_01062133";
