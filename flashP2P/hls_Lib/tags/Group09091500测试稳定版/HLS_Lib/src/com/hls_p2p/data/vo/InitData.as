package com.hls_p2p.data.vo
{
	...
	public dynamic class InitData
	{
		...
		private var _nextFlvURL:Array;
		private var _nextCdnInfoArr:Array;
		private var _nextPlaylevelArr:Array;
...
//			value=replaceParam(value,"format","2");
		...
		public function get nextFlvURL():Array
		{
			return _nextFlvURL;
		}
		
		public function set nextFlvURL(value:Array):void
		{
			_nextFlvURL = null;
			_nextFlvURL = value;
		}
		...
		public function set nextCdnInfo(value:Array):void
		{
			_nextCdnInfoArr = null;
			_nextCdnInfoArr = value;
			
			_nextFlvURL = new Array;
			_nextPlaylevelArr = new Array;
			for(var i:int=0 ; i<_nextCdnInfoArr.length ; i++)
			{
				_nextFlvURL.push(_nextCdnInfoArr[i]["location"]);
				_nextPlaylevelArr.push(_nextCdnInfoArr[i]["playlevel"]);
			}
		}
