...
//					}
//				}
				var str:String = String(stagePath+"act="+act+"&err="+err+"&utime="+obj.utime+"&ip="+IP+"&port="+Port+"&gID="+_groupID+"&ver="+LiveVodConfig.GET_VERSION()/*+testID*/+"&type="+LiveVodConfig.TYPE.toLowerCase()+"&termid="+termid+"&platid="+platid+"&splatid="+splatid+"&vtype="+LiveVodConfig.VTYPE+"&gdur="+gdur+"&r="+Math.floor(Math.random()*100000));
