package com.hls_p2p.dataManager
{
	...
	{
		function getDataTask():Object;
		function getNextSeqID(seqID:Number):Block;
//		function getNextblock_BySort(blockId:Number):Block;
		
		/**获得blockid*/
		function getBlockId(blockId:Number):Number;
		function getBlockId_withoutseqid(blockId:Number):Number;
...
//		function  getHead(blockId:Number):Head;
		...
		/**写clip数据*/
		function  writeClipList(clipList:Vector.<Clip>,isMinEnd:Boolean,p_blivevod:Boolean = false):void;
//		/**blocklist的最小分钟数*/
...
//		function getDescTask():Number;
		...
		function  getDataAfterPoint_withoutSeqid(id:Number):Array;
