...
//			}
		...
		public function getStatisticData():Object
		{
			...
			try
			{
				 ...
				 * type  live或vod
				 * */
				var str:String = String(nativeTrafficPath+"csize="+_httpsizeNum+"&dsize="+_p2psizeNum+"&dnode="+obj.dnode+"&lnode="+obj.lnode+"&gip="+_gIP+"&gport="+_gPort+"&rip="+_rIP+"&rport="+_rPort+"&gID="+_initData.groupName+"&ver="+LiveVodConfig.GET_VERSION()+"&type="+obj.type);		
