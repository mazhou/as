		...
		private function peerHartBeatTimer(event:* = null):void
		{
			...
			for(var remoteID:String in _pipeList)
			{
				...
				if(_pipeList[remoteID].canRecieved)
				{
					...
					//isJoinNetGroup = true;
					/**执行节点心跳*/
					_pipeList[remoteID].peerHartBeatTimer(NearestWantID);
			...
			trace(this,"_pipeSuccessNum = "+_pipeSuccessNum);
			trace(this,"_peerInPipeListNum+_sparePipeNum = "+(_peerInPipeListNum+_sparePipeNum));
