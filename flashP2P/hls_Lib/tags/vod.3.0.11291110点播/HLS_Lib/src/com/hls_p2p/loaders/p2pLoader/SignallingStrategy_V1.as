package com.hls_p2p.loaders.p2pLoader
{
	...
	public class SignallingStrategy_V1
	{
		...
		protected var dataManager:IDataManager				= null;
		...
		public function SignallingStrategy_V1(p_p2p_pipe:P2P_Pipe,p2pCluster:P2P_Cluster,dataManager:IDataManager)
		{
...
//			var version:String = name; 
			if(data)
			{
				...
				if( LiveVodConfig.TYPE == LiveVodConfig.LIVE )
				{
					...
					{
						this.dataManager.clearIsLoaded(data.CDNTaskPieceList);
					}
				}
