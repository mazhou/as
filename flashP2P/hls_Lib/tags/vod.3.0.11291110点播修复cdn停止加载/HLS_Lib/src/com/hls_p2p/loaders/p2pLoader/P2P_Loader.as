...
package com.hls_p2p.loaders.p2pLoader
{
	...
	public class P2P_Loader
	{
		...
		/**声明调度器*/
		private var _dataManager:IDataManager;
		/**保存网络运营商等信息*/
		...
		public function P2P_Loader(_dataManager:IDataManager,p2pCluster:P2P_Cluster)
		{
		...
		public function clear():void
		{
			...
			if( _pipeList )
			{
				for each( var sigallingStrategy:* in _pipeList )
				{
					try
					{
						sigallingStrategy.clear();
					}
					catch(err:Error)
					{
