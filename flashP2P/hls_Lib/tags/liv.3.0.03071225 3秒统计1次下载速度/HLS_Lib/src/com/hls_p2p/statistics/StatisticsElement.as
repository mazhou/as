package com.hls_p2p.statistics
{
	...
	internal class StatisticsElement
	{
		...
		/**周期内http累计下字节数*/
		private var _httpSizeForSpeed:Number;
		/**周期内p2p累计下字节数*/
		private var _p2pSizeForSpeed:Number;
		/**是否下载数据*/
		...
		public function dealDownloadSpeed():Object
		{
			...
			_newTimeForSpeed = getTime();
			durtion = Math.round((_newTimeForSpeed-_oldTimeForSpeed)/100)/10;
