package com.hls_p2p.data
{
	...
	public class BlockList 
	{
		...
		public function BlockList( dataMgr:DataManager,groupList:GroupList )
		{
			dataMgr_ = dataMgr;
...
//			return getBlockIdLoop( id,id );
		...
		public function eliminate():void
		{
			...
			if( streamSize >= LiveVodConfig.MEMORY_SIZE+1024*1024 || (blockArray.length > 300 && LiveVodConfig.TYPE == LiveVodConfig.LIVE ) )
			{
				...
				P2PDebug.traceMsg( this,"淘汰前 set memorySize:"+LiveVodConfig.MEMORY_SIZE+" _streamSize:"+streamSize+"("+int(streamSize/1024/1024)+")",blockArray.length,LiveVodConfig.ADD_DATA_TIME,LiveVodConfig.BlockID);
				var block:Block = null;
				if( LiveVodConfig.TYPE == LiveVodConfig.VOD )
				{
					...
					for(j = 0; j < blockArray.length;j++)
					{
						...
						{
							P2PDebug.traceMsg( this,"淘汰后 set memorySize:"+LiveVodConfig.MEMORY_SIZE+" _streamSize:"+streamSize+"("+int(streamSize/1024/1024)+")");
							cleanUpPieceList();
							return;
						}
					}
					...
					for(j = blockArray.length -1; j >= 0;j--)
					{
						...
						{
							P2PDebug.traceMsg( this,"淘汰后: _streamSize:"+streamSize+"("+int(streamSize/1024/1024)+")");
							cleanUpPieceList();
							return;
						}
					}
...
//						else
//						{
							P2PDebug.traceMsg( this,"淘汰后: _streamSize:"+streamSize+"("+int(streamSize/1024/1024)+")",blockArray.length);
							cleanUpPieceList();
							return;
//						}
					}
