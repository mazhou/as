...
//		}
		...
		{
			if( LiveVodConfig.CDN_DISABLE == 1/* && Statistic.getInstance().userAllowP2P != -1*/ )
			{
				return;
			}
			if (Task == null)
...
//				}
			...
			if(range != null)
			{
				...
				console.log(this,this.id+" url:"+url);
				/*if( range != "" )
				{
					Task.downLoadStat = 0;
				}*/
...
//			}
			...
			console.log(this,this.id+" range is null ");
			return null;
		}
