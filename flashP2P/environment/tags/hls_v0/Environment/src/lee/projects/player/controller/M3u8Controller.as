...
//	import RectLog.*;
	...
	import lee.projects.player.providers.M3u8Provider;
	...
	public class M3u8Controller extends EventDispatcher{
		...
		public function M3u8Controller() {
		}
...
//			GlobalReference.statisticManager.playerInit(initObject);
			GlobalReference.m3u8statisticManager.playerInit(initObject);
			...
			_player=new Player([new M3u8Provider()]);
