	...
	dynamic public class TweenLiteVars {
		...
		public function TweenLiteVars($vars:Object = null) {
			...
			if (TweenLite.version < 7.0) {
				trace(this+"TweenLiteVars error! Please update your TweenLite class or try deleting your ASO files. TweenLiteVars requires a more recent version. Download updates at http://www.TweenLite.com.");
			}
		}
