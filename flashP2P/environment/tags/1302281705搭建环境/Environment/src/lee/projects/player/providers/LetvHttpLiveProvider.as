package lee.projects.player.providers{
	...
	import com.p2p_live.core.P2PNetStream;
	...
	public class LetvHttpLiveProvider extends EventDispatcher implements IProvider{
		...
		protected function startPlayStream():void{
			...
			_ns.addEventListener("streamStatus",_ns_NET_STATUS);
		...
		protected function _ns_NET_STATUS(event:Object):void {
			...
			switch (code)
			{
				...
				case "Http.LoadXml.Success":
					RectManager.debug3('<FONT  COLOR="#009900" FACE="Courier New" SIZE="11">get xml, '+event.info.shiftTime+'</FONT>');
					break;
				...
				case "P2P.RemoveData.Success":
					RectManager.debug3('<FONT  COLOR="#990000" FACE="Courier New" SIZE="11">remove，'+event.info.id+'</FONT>');
					break;
				case "P2P.P2PGetChunk.Success" :
					RectManager.debug3('<FONT  COLOR="#209fc7" FACE="Courier New" SIZE="11">P2P, '+event.info.id+"_"+event.info.pieceID+", from: "+String(event.info.peerID).substr(0,10)+'</FONT>');
					break;
				case "P2P.P2PShareChunk.Success" :
					RectManager.debug3('<FONT  COLOR="#b26b05" FACE="Courier New" SIZE="11">P2P, '+event.info.bID+"_"+event.info.pID+", to: "+event.info.name+'</FONT>');
					break;
				case "P2P.P2PWantChunk.Success" :
					RectManager.debug3('<FONT  COLOR="#990000" FACE="Courier New" SIZE="11">对方索取数据，id='+event.info.bID+"_"+event.info.pID+",to="+event.info.name+' ----></FONT>');
					break;
