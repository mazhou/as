package lee.projects.player.view{
	...
	public class LiveControlbar extends BaseUI{
        ...
        //
		public function LiveControlbar(player:Player,config:XML=null) {
			...
			_btnBg=cb.getChildByName("btnBg") as Sprite;
			...
			//_seekSlider.addEventListener(MouseEvent.MOUSE_OVER,_seekOver);
			...
			_seekSlider.skin.visible=true;
			_seekSliderOffset = 0;
			//_background.visible=false;
			//_showBtn1.visible=false;
			//_showBtn2.visible=false;
			//_showBtn3.visible=false;
			_gaoqingBtn.skin.visible=false;
			_biaoqingBtn.skin.visible=false;
		...
		/*private function _seekOver(e:MouseEvent):void
		{
			trace("pppppppppppppppppp")
		}*/
...
/*		protected function setTime(obj:Object=null):void{
		...
		protected function _player_PLAYHEAD(event:PlayerEvent):void{
			setTime(event.info.time);
			//trace("event.info.time "+event.info.time)
			if(!_seekSlider.isDraging&&_player.state==PlayerState.PLAYING)
			{
				...
				//_seekSlider.fullnessSprite.width = 0
			}
		}
