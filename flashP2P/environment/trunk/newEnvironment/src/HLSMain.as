package 
{
	...
	{
		private var vars:FlashVars = FlashVars.getInstance();
		...
		{//test()
			vars.setVars(this.loaderInfo.parameters);
			GlobalReference.HLSstatisticManager=new HLSStatisticManager();//上报管理
